...
module.exports = answers => {
  ...
  const data = {
    ...
    testStage: answers.stages.includes('test') ? STAGES_DEPLOY_SCRIPTS.test : '',
    accStage: answers.stages.includes('acc') ? STAGES_DEPLOY_SCRIPTS.acc : '',
    prodStage: answers.stages.includes('prod') ? STAGES_DEPLOY_SCRIPTS.prod : '',
